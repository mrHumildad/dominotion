...
const hexColors = {
  white: "#cec0c3ff",     // instituciones orden
  black: "#151514ff",   // crimen caos

  gold: "#fdb839ff",   // financia capital
  green: "#32CD32",   // ciencia progreso

  violet: "#e22b9fff",       // social influencia
  blue: "#0000CD"   // control fe
};

export const newIdeo = {
  orden: {
    sub: ['totalitarista', 'neo conservador', ],
    opposite: 'caos',
    field: 'instituciones',
    adjectives: [],
  },
  caos: {
    sub: ['anarchista', 'nihilista', 'prepper', 'primitivista', ],
    opposite: 'orden',
    field: 'crimen',
    adjectives: [],
  },
  capital: {
    sub: ['capitalista', 'colonialista', ],
    opposite: 'progreso',
    field: 'financia',
    adjectives: [],
  },
  progreso: {
    sub: ['utopista', 'reformista', 'tecnocrata', 'ecologista', 'futurista', 'transumanista'],
    opposite: 'capital',
    field: 'ciencia',
    adjectives: [],
  },
  influencia: {
    sub: ['conspiranoico', 'hedonista', ],
    opposite: 'fe',
    field: 'social',
    adjectives: [],
  },
...
export const newFields = {
  instituciones: {
    sub: ['politica', 'ley', 'ONG', 'org.international/diplomacia', 'policia', 'militar'  ],
    opposite: 'crimen',
    ideology: 'orden',
    resource: 'poder'
  },
  crimen : {
    sub: ['trafico', 'mafia', 'expl.humana', 'gang?', ],
    opposite: 'instituciones',
    ideology: 'caos',
    resource: 'ilegal'
  },       
  financia: {
    sub: ['mercados', 'banco', 'crypto', 'industria', 'transportes'],
    opposite: 'ciencia',
    ideology: 'capital',
    resource: 'dinero'
  },      
  ciencia: {
    sub: [ 'biologia', 'robotica', 'comunicaciones', 'economia', 'sociologia', 'psicologia' ],
    opposite: 'financia',
    ideology: 'progreso',
    resource: 'recerca'
  },       
  social: {
    sub: ['arte', 'redes sociales', 'periodismo', 'musica', 'wellfare', 'educacion' ],
    opposite: 'control',
    ideology: 'influencia',
    resource: 'informacion'
  },        
  control: {
    sub: ['logia', 'servicios secretos', 'censura', 'lobby', 'terrorismo', 'religion'],
    opposite: 'social',
    ideology: 'fe',
    resource: 'cadena'
  },
